...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mLight = (ImageView) view.findViewById(R.id.light);
        mLight.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (isOn == false){
                    CodeUtils.isLightEnable(!isOn);
                    mLight.setImageDrawable(ContextCompat.getDrawable(getContext(),R.drawable.scan2code_icon_light_sel));
                    isOn = true;
                }else {
                    isOn = false;
                    CodeUtils.isLightEnable(isOn);
                    mLight.setImageDrawable(ContextCompat.getDrawable(getContext(),R.drawable.scan2code_icon_light_nor));
                }
